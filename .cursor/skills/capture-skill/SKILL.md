...
1. Check pod status: `kubectl get pods -n | grep -v Running`
2. Get events: `kubectl describe pod -n `
3. Check logs: `kubectl logs -n --previous`
...
### ImagePullBackOff
- Verify image tag exists: `docker manifest inspect `
